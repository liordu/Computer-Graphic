...
mat4.perspective = function (out, fovy, near, far) {
    ...
    // set r = t because we don't know the aspect ratio??
...
class Camera3D {
    ...
    update() {
        ...
        this.cameraMatrix[12] = - vec3.dot(this.u, this.eye);
        this.cameraMatrix[13] = - vec3.dot(this.v, this.eye);
        this.cameraMatrix[14] = - vec3.dot(this.w, this.eye);
